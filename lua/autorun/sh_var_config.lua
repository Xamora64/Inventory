...
ConVars.table_acces_staff = CreateConVar("table_acces_staff", table_to_string(config.acces_staff), FCVAR_PROTECTED, "Which group have acces to Staff Menu Inventory", nil, nil)
